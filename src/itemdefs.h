...
#define WHOLE_RUNNING_POWER_RECT_Y 100
#define WHOLE_RUNNING_POWER_RECT_W 5
#define WHOLE_RUNNING_POWER_RECT_H 200

#define WHOLE_EXPERIENCE_COUNTDOWN_RECT_X 100
#define WHOLE_EXPERIENCE_COUNTDOWN_RECT_Y 8
#define WHOLE_EXPERIENCE_COUNTDOWN_RECT_W 300
#define WHOLE_EXPERIENCE_COUNTDOWN_RECT_H 3
