...
#define CURRENT_SKILL_RECT_Y (SCREEN_HEIGHT - 16 - 64)
...
#define WHOLE_RUNNING_POWER_RECT_Y ((1.0-GOLDEN_SCHNITT)*SCREEN_HEIGHT)/2
#define WHOLE_RUNNING_POWER_RECT_W 5
#define WHOLE_RUNNING_POWER_RECT_H (GOLDEN_SCHNITT*SCREEN_HEIGHT)

// #define WHOLE_EXPERIENCE_COUNTDOWN_RECT_X ((1.0-GOLDEN_SCHNITT)*SCREEN_WIDTH)/2
#define WHOLE_EXPERIENCE_COUNTDOWN_RECT_X (1.0)
#define WHOLE_EXPERIENCE_COUNTDOWN_RECT_Y 8
#define WHOLE_EXPERIENCE_COUNTDOWN_RECT_W (GOLDEN_SCHNITT*SCREEN_WIDTH)
