...
#define CURRENT_SKILL_RECT_X 549
...
#define WHOLE_RUNNING_POWER_RECT_X 5
#define WHOLE_RUNNING_POWER_RECT_Y (480-90) 
#define WHOLE_RUNNING_POWER_RECT_W 10
#define WHOLE_RUNNING_POWER_RECT_H 64

#define WHOLE_EXPERIENCE_COUNTDOWN_RECT_X 18
