...
void CrySound ( void ) {play_sample_using_WAV_cache( "../effects/Cry_Sound_0.wav", FALSE , FALSE );}; 

void play_open_chest_sound( void ) { PlayOnceNeededSoundSample ( "../effects/open_chest_sound.wav" , FALSE , TRUE ); };

void Play_Spell_ForceToEnergy_Sound( ) { play_sample_using_WAV_cache( "../effects/Spell_ForceToEnergy_Sound_0.wav", FALSE , FALSE ); }

void Play_Spell_DetectItems_Sound( ) { play_sample_using_WAV_cache( "../effects/Spell_DetectItems_Sound_0.wav", FALSE , FALSE ); } ;
 ...
 * ---------------------------------------------------------------------- */
void
application_requirements_not_met_sound ( void ){play_sample_using_WAV_cache ( "../effects/tux_ingame_comments/i_cannot_use_this_item_yet.ogg", FALSE , FALSE );};
