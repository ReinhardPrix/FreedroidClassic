...
#define MAX_ENEMY_MOVEMENT_PHASES 15
...
#define NUMBER_OF_OBSTACLE_TYPES 119
...
#define TUX_TOTAL_PHASES (TUX_SWING_PHASES+TUX_BREATHE_PHASES+TUX_GOT_HIT_PHASES+TUX_WALK_CYCLE_PHASES)
