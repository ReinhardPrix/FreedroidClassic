...
#define MAX_ENEMY_MOVEMENT_PHASES 31
...
enum _sounds
{
  ...
  SWING_THEN_HIT_1_SOUND,
  SWING_THEN_HIT_2_SOUND,
  SWING_THEN_HIT_3_SOUND,
  SWING_THEN_HIT_4_SOUND,
  SWING_THEN_NOHIT_1_SOUND,
  SWING_THEN_NOHIT_2_SOUND,
  SWING_THEN_NOHIT_3_SOUND,
  SWING_THEN_NOHIT_4_SOUND,
