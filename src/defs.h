...
#define ENEMY_ROTATION_MODELS_AVAILABLE 31
#define ROTATION_ANGLES_PER_ROTATION_MODEL 8

#define MAX_ENEMY_MOVEMENT_PHASES 32
...
#define NUMBER_OF_SKILLS ( NUMBER_OF_SKILLS_PER_SKILL_PAGE * NUMBER_OF_SKILL_PAGES )
...
#define FIXED_ZOOM_OUT_FACT 4.0
...
#define FREEDROID_LOADING_PICTURE_CODE 15
#define MOUSE_BUTTON_CHA_BACKGROUND_PICTURE_CODE 16
#define MOUSE_BUTTON_INV_BACKGROUND_PICTURE_CODE 17
#define MOUSE_BUTTON_SKI_BACKGROUND_PICTURE_CODE 18
...
#define CHAT_SUBDIALOG_WINDOW_X (260) 
#define CHAT_SUBDIALOG_WINDOW_Y (42)
#define CHAT_SUBDIALOG_WINDOW_W (337)
#define CHAT_SUBDIALOG_WINDOW_H (216)
