...
#define ENEMY_ROTATION_MODELS_AVAILABLE 32
...
enum
{
  ...
  ISO_SIDEWALK_3 ,
  ISO_SIDEWALK_4 ,
  ISO_SIDEWALK_SLIDE_1 ,
  ISO_SIDEWALK_SLIDE_2 ,
  ISO_SIDEWALK_SLIDE_3 ,
  ISO_SIDEWALK_SLIDE_4 ,
  ISO_SIDEWALK_BUMP_1 ,
  ISO_SIDEWALK_BUMP_2 ,
  ISO_SIDEWALK_BUMP_3 ,
  ISO_SIDEWALK_BUMP_4 ,
  ISO_SIDEWALK_CORNER_1 ,
  ISO_SIDEWALK_CORNER_2 ,
  ISO_SIDEWALK_CORNER_3 ,
  ISO_SIDEWALK_CORNER_4 , 
  ISO_SIDEWALK_INNER_CORNER_1 ,
  ISO_SIDEWALK_INNER_CORNER_2 ,
  ISO_SIDEWALK_INNER_CORNER_3 ,
  ISO_SIDEWALK_INNER_CORNER_4 ,
