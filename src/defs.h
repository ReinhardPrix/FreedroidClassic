...
#define MAX_MOUSE_PRESS_BUTTONS 18
enum
  { 
    CHA_BUTTON, 
    INV_BUTTON,
    ...
    RIGHT_BUTTON,
    MAP_EXIT_BUTTON,
    MAP_UNLOCK_BUTTON_GRAY,
    MAP_UNLOCK_BUTTON_YELLOW,
    MAP_UNLOCK_BUTTON_RED,
    MAP_GUNONOFF_BUTTON_GRAY,
    MAP_GUNONOFF_BUTTON_YELLOW,
    MAP_GUNONOFF_BUTTON_RED,
...
enum
{
  ...
  IDENTIFY_L=59,   IDENTIFY_R,     IDENTIFY_U,     IDENTIFY_D
};
