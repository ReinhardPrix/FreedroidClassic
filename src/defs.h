...
#define ENEMY_ROTATION_MODELS_AVAILABLE 27
...
#define NUMBER_OF_ITEM_PICTURES 60
...
enum
{ ONLY_SHOW_MAP = 1 , DO_SCREEN_UPDATE = 2 , ONLY_SHOW_MAP_AND_TEXT = 4 , SHOW_GRID = 8 };
...
enum _sounds
{
  ...
  SHOP_ITEM_SOLD_SOUND_0,
  SHOP_ITEM_BOUGHT_SOUND_0,
  SHOP_ITEM_REPAIRED_SOUND_0,
  SHOP_ITEM_IDENTIFIED_SOUND_0,
  NO_AMMO_SOUND_0
};
...
enum
{
  ...
  CAVE_FLOOR, CAVE_V_WALL,     CAVE_H_WALL,       
  CAVE_CORNER_LU,        CAVE_CORNER_RU,       CAVE_CORNER_LD,      CAVE_CORNER_RD,
  FLOOR_CAVE_L,  FLOOR_CAVE_R, FLOOR_CAVE_U, FLOOR_CAVE_D,
